...
type service interface {
	...
	UpsertTrackActivities(ctx context.Context, userID uint, request trackacktivities.TrackActivityRequest) error
	GetRecommendation(ctx context.Context, userID uint, limit int, trackID string) (*spotify.RecommendationsResponse, error)
}
