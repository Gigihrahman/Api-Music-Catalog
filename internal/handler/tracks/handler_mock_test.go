...
import (
	spotify "api-music/internal/models/spotify"
...
func (m *Mockservice) GetRecommendation(ctx context.Context, userID uint, limit int, trackID string) (*spotify.RecommendationsResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRecommendation", ctx, userID, limit, trackID)
	ret0, _ := ret[0].(*spotify.RecommendationsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *Mockservice) UpsertTrackActivities(ctx context.Context, userID uint, request trackacktivities.TrackActivityRequest) error {
	m.ctrl.T.Helper()
